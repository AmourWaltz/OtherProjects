...
#define OLED_SCLK_PIN      (GPIO_Pin12)
#define OLED_SCLK_NUM      (12)

#define OLED_SDIN_PORT     (PTE)
#define OLED_SDIN_PIN      (GPIO_Pin11)
#define OLED_SDIN_NUM      (11)

#define OLED_DC_PORT       (PTE)
#define OLED_DC_PIN        (GPIO_Pin8)
#define OLED_DC_NUM        (8)

#define OLED_RST_PORT      (PTE)
#define OLED_RST_PIN       (GPIO_Pin9)
#define OLED_RST_NUM       (9)
